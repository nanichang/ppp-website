...
OrgChart.prototype.load = function (t) {
    ...
    this.server.read(t, this.width(), this.height(), e, v, y, function (t) {
        ...
        var r = b.ui.defs(e.defs), i = b.getScale(t.viewBox);
        r += b.ui.pointer(b.config, v, i);
        var a = b.getViewBox(), n = t.viewBox;
        ...
        for (var o in OrgChart.events.publish("prerender", [b, e]), r = e.content, t.visibleNodes) {
            var l = t.visibleNodes[o], s = b._get(o);
        ...
        if (OrgChart.events.publish("render", [b, e]), r = e.content, r += b.ui.lonely(b.config), v !== OrgChart.action.exporting) {
            ...
            v === OrgChart.action.centerNode ? OrgChart.anim(b.getSvg(), {viewbox: a}, {viewbox: b.response.viewBox}, b.config.anim.duration, b.config.anim.func, function () {
    ...
    if (null != i) {
        ...
        if (null != a) {
            ...
            var h = i.w, d = i.h, c = o < h - o ? h - o : o, g = l < d - l ? d - l : l, p = (g = g) < (c = c) ? c : g,
                ...
                m = document.createElementNS("http://www.w3.org/2000/svg", "circle"), O = OrgChart._randomId();
            u.setAttribute("id", O);
    ...
    var l = {parentState: r, childrenState: i, rippleId: a, vertical: n, horizontal: o};
    ...
    if (this._canUpdateLink(t, e)) {
        ...
        if (r.isGroup && i.isGroup) for (var a = i.bgnodes[0].id, n = 0; n < r.bgnodes.length; n++) {
            (o = this.get(r.bgnodes[n].id)).pid = a, this.update(o, !0)
        } else if (!r.isGroup && i.isGroup) {
            a = i.bgnodes[0].id;
            (o = this.get(t)).pid = a, this.update(o, !0)
        } else if (r.isGroup && !i.isGroup) for (n = 0; n < r.bgnodes.length; n++) {
        ...
        if (r.isChildOfGroup) {
            ...
            if (2 == l.bgnodes.length) for (n = 0; n < l.bgnodes.length; n++) {
                var s = l.bgnodes[n];
    ...
    if (this.update(t, e)) {
        var i = t.pid;
        null != i && null != i && "" != i || (i = t.id), this._draw(!1, OrgChart.action.update, {id: i}, function () {
            r.ripple(t.id)
        })
    }
    ...
    i && i.isChildOfGroup && (a = i._groupParentNodeId), this._draw(!1, r, {id: a, insertedNodeId: t.id})
    ...
    var r = this.getBGNode(t), i = this.getBGNode(e), a = this, n = i.id;
    if (r.isGroup || i.isGroup || r.isChildOfGroup || i.isChildOfGroup) if (r.isGroup || i.isGroup || !r.isChildOfGroup || i.isChildOfGroup) if (r.isGroup || i.isGroup || r.isChildOfGroup || !i.isChildOfGroup) !r.isGroup && !i.isGroup && r.isChildOfGroup && i.isChildOfGroup && (this._removeGroupIfHasOneNode(r._groupParentNodeId, r.id), this.removeNodeTag(r.id, r._groupParentNodeId, !0), this.addNodeTag(r.id, i._groupParentNodeId, !0)); else {
        ...
        if (r.id != l) this.link(r.id, l); else {
    ...
    null == i && (i = !1);
    var n = document.createElement("div"), o = document.createElement("div"), l = document.createElement("input"),
        s = document.createElement("hr"), h = document.createElement("button");
    if (h.innerHTML = "Upload", h.style.position = "absolute", h.style.right = 0, n.style.margin = "14px 14px 7px 14px", n.style.textAlign = "left", n.style.position = "relative", s.style.border = "1px solid #d7d7d7", s.style.backgroundColor = "#d7d7d7", s.style.display = "block", s.style.width = "100%", o.style.floa = "left", o.style.color = "#bcbcbc", l.style.border = "none", l.style.outline = "none", l.style.width = "100%", a && (l.style.width = "80%"), l.style.fontSize = "16px", l.readOnly = i, null != e && null != e && (l.value = e), null != r && null != r && (l.placeholder = r), null != t && null != t && (o.innerHTML = t), o.setAttribute("label", t), l.style.color = "#7a7a7a", i || l.addEventListener("focus", function () {
        ...
        t.style.border = "1px solid #039BE5", OrgChart.anim(t, {width: 10}, {width: n.clientWidth}, 250, OrgChart.anim.inOutSin)
    ...
    l.className = "edit-assistant-button-content", a.innerHTML = '<svg style="width: 34px; height: 34px;"><path style="fill:#ffffff;" d="M21.205,5.007c-0.429-0.444-1.143-0.444-1.587,0c-0.429,0.429-0.429,1.143,0,1.571l8.047,8.047H1.111 C0.492,14.626,0,15.118,0,15.737c0,0.619,0.492,1.127,1.111,1.127h26.554l-8.047,8.032c-0.429,0.444-0.429,1.159,0,1.587 c0.444,0.444,1.159,0.444,1.587,0l9.952-9.952c0.444-0.429,0.444-1.143,0-1.571L21.205,5.007z"></path></svg>', this.wrapperElement.id = "bgEditForm", Object.assign(a.style, {
        ...
        color: "#4285F4",
        cursor: "pointer"
    }), Object.assign(l.style, {margin: "14px 14px 7px", color: "rgb(188, 188, 188)"}), n.innerHTML = "Add new field";
    ...
    for (var c = 0; c < h.length; c++) {
        var g = d[h[c]];
        if (t.isGroup && (g = this.obj.config.tags[t.id]["group" + h[c]]), "tags" != h[c]) if (OrgChart._fieldIsImg(this.obj.config, h[c])) {
            if (g) {
    ...
    if ("" != r) {
        ...
        OrgChart.anim(this.wrapper, {opacity: 0, left: d - this.wrapper.offsetWidth}, {
            opacity: 1,
            left: c
        ...
        for (var g = this.wrapper.getElementsByTagName("div"), p = 0; p < g.length; p++) {
            (i = g[p]).addEventListener("mouseover", function () {
                ...
                if (void 0 === l[r].onClick) if ("add" === r) {
                    ...
                    expandChildren: !1,
                    nodeId: n
                }) : "csv" === r ? s.obj.exportCSV() : "addInGroup" === r ? s.obj.group(n, o) : "addAsChild" === r && s.obj.linkNode(n, o); else e = l[r].onClick.call(s.obj, n, o);
                0 != e && s.hide()
            })
        }
    }
    ...
    if (e) {
        ...
        var r = this.div.querySelector('[data-tlbr="plus"]'), i = this.div.querySelector('[data-tlbr="minus"]'),
            a = this.div.querySelector('[data-tlbr="fit"]'), n = this.div.querySelector('[data-tlbr="expand"]'),
            o = this;
    ...
    var n = this, t = {id: i.nodeId, expandChildren: i.expandChildren};
    this._draw(!1, OrgChart.action.exporting, t, function (t) {
        var r = document.createElement("div");
        if (r.innerHTML = t, "svg" == i.ext) if (a) a(i, r.innerHTML); else {
    ...
    var t = {id: o.nodeId, expandChildren: o.expandChildren}, c = [], g = [];
    ...
    var r = e.getAttribute("width"), i = e.getAttribute("height"), a = OrgChart.pdfPrevUI._getViewBox(e),
    ...
    var r = e.getAttribute("width"), i = e.getAttribute("height"), a = 0, n = 0;
    switch (t.format) {
        case"A4":
        case"A42Levels":
    ...
    var o = OrgChart.pdfPrevUI._getViewBox(e), l = {
        ...
        }, s = {w: t.landscape ? n : a, h: t.landscape ? a : n}, h = r / l.w, d = i / l.h, c = d < h ? h : d, g = o[0],
        p = o[1] / c, f = o[2], u = o[3] / c;
    ...
    var r = e.getAttribute("width"), i = e.getAttribute("height"), a = OrgChart.pdfPrevUI._getViewBox(e), n = 0, o = 0;
    switch (t.format) {
        case"A4":
        case"A42Levels":
    ...
    var p = c.w, f = c.h, u = l, C = s, m = [];
    for (console.log("vh: " + d); u < h;) {
        for (; C < d;) {
            var O = [u, C, h, d];
            O = O.join(), m.push({vb: O, innerSize: c, size: g}), C += c.h, i < (f += c.h) && (f = i)
        }
        ...
        s.onload = function () {
            for (var t = s.result, e = OrgChart._csvToArray(t, ","), r = [], i = 1; i < e.length; i++) {
                for (var a = {}, n = 0; n < e[i].length; n++) {
                    var o = e[0][n], l = e[i][n];
                    if ("tags" == o && "" != l) l = l.split(","); else if ("tags" == o && "" == l) continue;
                    a[o] = l
                }
                "" != a.id.trim() && r.push(a)
            }
    ...
    if (-1 != e.type.indexOf("touch") && this._touch && 1 == e.changedTouches.length) {
        if (e.changedTouches.length) {
            var r = e.changedTouches[0].clientX, i = e.changedTouches[0].clientY,
                a = OrgChart.t(this.config.template, this.getScale()).size, n = this.getScale(),
    ...
    if (Array.isArray(r.tags)) for (var a = 0; a < r.tags.length; a++) {
        var n = r.tags[a];
    ...
    if (this.config.enableDragDrop) {
        var r = OrgChart._getClientXY(e), i = t.getAttribute("node-id"), l = this.getBGNode(i), s = null, h = null;
        ...
        var d = this, c = this.getSvg(), g = {x: r.x, y: r.y}, p = OrgChart._getTransform(t), f = p[4], u = p[5],
            C = d.getScale(), m = t.cloneNode(!0);
        if (c.insertBefore(m, c.firstChild), m.style.opacity = .7, l.isChildOfGroup) {
            var a = this.getNodeElement(l._groupParentNodeId), n = OrgChart._getTransform(a);
            f += n[4], u += n[5], p[4] = f, p[5] = u, m.setAttribute("transform", "matrix(" + p.toString() + ")")
        }
        var O = function (t) {
            var e, r = OrgChart._getClientXY(t), i = document.elementFromPoint(r.x, r.y);
            if (null != s && ((e = d.getBGNode(s)).isChildOfGroup ? (d.getNodeElement(e._groupParentNodeId).style.opacity = 1, h.style.opacity = 1) : e.isGroup || (h.style.opacity = 1)), h = s = null, d.config.enableDragDrop) for (; null != i && i != c;) {
            ...
            var e = d.getBGNode(s);
            if (null == d.config.dragDropMenu || l.isGroup && !e.isGroup) d._canUpdateLink(l.id, s) ? d.linkNode(l.id, s) : c.removeChild(m); else if (d._canUpdateLink(l.id, s)) {
                var r = OrgChart._getOffsetXY(d.element, t), i = null;
    ...
    this.searchUI.hide(), this.nodeMenuUI.hide(), this.nodeContextMenuUI.hide(), this.dragDropMenuUI.hide(), this.menuUI.hide();
    var i = OrgChart._menuPosition(e, r, this.getSvg()), a = this.getBGNode(t), n = null;
    if (Array.isArray(a.tags)) for (var o = 0; o < a.tags.length; o++) {
        var l = a.tags[o];
    ...
    OrgChart.LIMIT_NODES || (l.l = !0), null != OrgChart.remote._fromReqDTO ? OrgChart.remote._fromReqDTO(l.n, l.r, l.c, function (t) {
        ...
        t ? OrgChart.remote._proceed(r, e.res, i) : OrgChart.remote._findRegion(function (t) {
            OrgChart._ajax(t, "post", l, "json", function (t) {
                t.error ? i(2) : (OrgChart.remote._proceed(r, t, i), OrgChart.idb.write({id: l, res: t}))
            })
        })
    }))
    ...
    var n = this, o = OrgChart.server._createNodes(this.config, this.action, this.actionParams, this.oldNodes);
    t(o);
    var l = o.nodes, s = o.roots, e = OrgChart.remote;
    ...
    for (s = 0; s < o.length && 10 != s; s++) {
        for (var g = !1, p = 0; p < l.length; p++) if (l[p].id == o[s].id) {
            g = !0;
            break
        }
        if (!g) {
            var f = "", u = "", C = "", m = "", O = Object.getOwnPropertyNames(o[s].data);
    ...
    for (var a = t.nodes, n = {}, o = [], l = [], s = [], h = {}, d = !1, c = 0; c < a.length; c++) {
        var g = a[c], p = Array.isArray(g.tags) ? g.tags.slice(0) : [], f = OrgChart._getGroup(p, t.tags),
            u = OrgChart._getTemplate(p, t.tags, t.template), C = Array.isArray(g.spids) ? g.spids : null;
    ...
    }), d) for (c = 0; c < o.length; c++) {
        h[(y = n[o[c]]).pid] && (y.pid = h[y.pid])
    }
    var O = [];
    for (c = 0; c < o.length; c++) {
        var v = o[c], y = n[v], x = i ? i[v] : null;
        if (null != y.pid && null != y.pid && "" !== y.pid) (_ = n[y.pid]) ? ((y.parent = _).children.push(y), _.childrenIds.push(y.id)) : (y.pid = null, y.parent = null, l.push(y)); else l.push(y);
    ...
    if (null != t.roots) {
        ...
        for (c = 0; c < t.roots.length; c++) {
            var b = n[t.roots[c]];
            if (b) {
                if (b.parent) for (var w = (_ = b.parent).children.length - 1; 0 <= w; w--) {
    ...
    for (c = 0; c < s.length; c++) {
        var _ = n[s[c]], k = new OrgChart.node(_.id + "_split_0", _.id, null, [], "split");
        ...
        if (A.length % 2) {
            var S = n[A[A.length - 1]], I = [S.w, S.h], N = "transperant_" + S.templateName;
        ...
        for (w = A.length - 1; 0 <= w; w--) {
            if (w % 2 && w != A.length - 1) (J = new OrgChart.node(_.id + "_split_" + M, null, null, [], "split")).isAssistant = !0, n[J.id] = J, A.splice(w, 0, J.id), M++; else w % 2 && A.splice(w, 0, k.id)
        }
        for (w = 0; w < A.length; w += 3) {
            var E = null;
            E = 0 == w ? _ : n[A[w - 2]];
            var L = n[A[w]], B = n[A[w + 1]], T = n[A[w + 2]];
            ...
            for (var H = E; "split" == H.templateName && (H = H.parent);) H.childrenIds.push(L.id), H.childrenIds.push(B.id), H.childrenIds.push(T.id)
        }
    }
    if (e == OrgChart.action.centerNode) {
        ...
        for (var z = P.id; null != _;) {
            if (-1 != (D = O.indexOf(_.id)) && O.splice(D, 1), _.state = OrgChart.EXPAND, r.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS) for (c = 0; c < _.childrenIds.length; c++) {
            ...
            if (_.state == OrgChart.EXPAND) for (var F = 0; F < _.childrenIds.length; F++) {
        ...
        if (r.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS) for (c = 0; c < P.childrenIds.length; c++) {
            if (-1 != (D = O.indexOf(P.childrenIds[c])) && O.splice(D, 1), (U = n[P.childrenIds[c]]).state = OrgChart.EXPAND, !U.isAssistant && !OrgChart.server._isSplit(U)) for (w = 0; w < U.childrenIds.length; w++) {
                var D, G = n[U.childrenIds[w]];
                -1 == (D = O.indexOf(U.childrenIds[w])) && O.push(U.childrenIds[w]), G.state = OrgChart.COLLAPSE
            }
        }
    }
    e == OrgChart.action.exporting && 1 == r.expandChildren && y && (O = []);
    for (c = 0; c < O.length; c++) {
        if (_ = (y = n[O[c]]).parent) for (w = _.children.length - 1; 0 <= w; w--) {
            if (_.children[w] == y) if (-1 == _.collapsedChildrenIds.indexOf(y.id) && _.collapsedChildrenIds.push(y.id), _.children.splice(w, 1), "split" == y.templateName || "split" == _.templateName) {
                if (E = y.parent) {
                    for (; "split" == E.templateName;) E = E.parent;
                    for (var R = 0; R < E.childrenIds.length; R++) {
                        var X = E.childrenIds[R];
                        -1 == E.collapsedChildrenIds.indexOf(X) && E.collapsedChildrenIds.push(X)
                    }
                }
            } else y.parent = null
        }
    }
    if (t.layout == OrgChart.mixed) for (c = 0; c < o.length; c++) {
        if (0 == (y = n[o[c]]).childrenIds.length && !y.isAssistant && "split" != y.templateName) if (_ = y.parent) {
    ...
    if (t.layout == OrgChart.tree || t.layout == OrgChart.treeRightOffset || t.layout == OrgChart.treeLeftOffset) {
        ...
        for (c = 0; c < q.length; c++) {
            ...
            var V = [];
            for (w = _.children.length - 1; 0 <= w; w--) {
                if (OrgChart.server._mixedLayoutAllNodes(_)) if (0 == (U = _.children[w]).childrenIds.length && !U.isAssistant && "split" != U.templateName && (U.parent && "split" != U.parent.templateName || U.parent.isAssistant)) {
            ...
            for (M = 1, w = V.length - 1; 0 <= w; w--) {
                var J;
                if (w % 2 && w != V.length - 1) (J = new OrgChart.node(_.id + "_split_" + M, null, null, [], "split")).layout = OrgChart.tree, n[J.id] = J, V.splice(w, 0, J.id), M++; else w % 2 && V.splice(w, 0, k.id)
            }
    ...
    if (r == OrgChart.action.init && t) {
        if (t.tags) for (var o = 0; o < t.tags.length; o++) {
            var l = t.tags[o];
        ...
        if (a.state == OrgChart.COLLAPSE) n.push(t.id); else if (a.state == OrgChart.EXPAND) {
            var s;
    ...
    if (r == OrgChart.action.exporting && 1 == a.expandChildren && t) OrgChart.server._setNodeGroupState(t, OrgChart.EXPAND, i.orientation); else {
    ...
    var i = OrgChart.t(e), a = i.size[0], n = i.size[1];
    if (t.isGroup && t.groupState == OrgChart.EXPAND) {
        var o = t.bgnodes.length, l = 0, s = null, h = n = a = 0, d = 0;
        ...
        t._groupSettings = {_rows: s, _columns: l, _cellWidth: h, _cellHeight: d}, OrgChart.server._setGroupNodes(t, r)
    }
    t.w = a, t.h = n
    ...
    for (r = 0; r < t.nodes.length; r++) for (var i in t.nodes[r]) i !== OrgChart.ID && i !== OrgChart.TAGS && i !== OrgChart.NODES && i !== OrgChart.PID && (t.nodeBinding[i] || OrgChart._arrayContains(e, i) || e.push(i));
    return e
    ...
    if (r == OrgChart.action.expandCollapse || r == OrgChart.action.groupMaxMin || r == OrgChart.action.centerNode || r == OrgChart.action.update || r == OrgChart.action.insert) {
        ...
        if (null != i.id) {
            ...
            var l = e[o];
            if (!l) for (var s in e) for (var h = e[s].bgnodes, d = 0; d < h.length; d++) if (h[d].id == o) {
                l = e[s];
                break
            }
            var c = a[o];
            if (!c) for (var s in a) for (h = a[s].bgnodes, d = 0; d < h.length; d++) if (h[d].id == o) {
                c = a[s];
                break
            }
            if (c) {
    ...
    if (t.isGroup && t.groupState == OrgChart.EXPAND) {
        var r = OrgChart.t(t.templateName), i = 0, a = 0;
        ...
        } else for (o = 0; o < t.bgnodes.length; o++) {
            var s;
    ...
    var u = {}, C = {top: null, left: null, bottom: null, right: null, minX: null, maxX: null, minY: null, maxY: null},
        m = [[], [], []], O = a - o + 2 * i.padding, v = n - l + 2 * i.padding,
    ...
    for (var S in g) {
        ...
        if (OrgChart.server._isVisible(I, i, s, d)) {
            ...
            if (d == OrgChart.action.expandCollapse && f && f[I.id] && "expandCollapseToLevel" == c.method) {
                ...
                var T;
                N = {x: (T = f[I.id]).x, y: T.y}
            } else d !== OrgChart.action.exporting && r && !r[I.id] && (m[0].push(I.id), m[1].push({opacity: 0}), m[2].push({opacity: 1}));
    ...
    _defsIds: {}, defs: function (t) {
        ...
        var d = OrgChart.t(t.templateName, s), c = d.node.replaceAll("{w}", t.w).replaceAll("{h}", t.h);
        ...
        var m = OrgChart._getPosition(r, t, a, n), O = "node";
        ...
        var a = "", n = 0, o = 0, l = OrgChart.t(t.templateName, i);
        switch (e.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
        ...
        for (var n = "", o = 0; o < e.spids.length; o++) {
            var l = [], s = e.spids[o], h = null, d = "left";
            if (t[s]) {
                switch (r.orientation) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                ...
                var c = OrgChart.t(e.templateName, a), g = r.levelSeparation;
                ...
                for (var f = e; null == h;) {
                    var u = !1, C = f.parent, m = C.leftNeighbor, O = C.rightNeighbor;
        ...
        var a = OrgChart.t(t.templateName, i), n = [], o = r.levelSeparation / 2;
    ...
    e.offsetX, e.offsetY;
    var i = t.getBoundingClientRect(), a = r.getBoundingClientRect();
    ...
    if ("multiline" == s) {
        var p = t.split(" "), f = d.getBBox().height;
        d.textContent = "";
        var u = document.createElementNS(h, "tspan"), C = document.createTextNode(p[0]);
    ...
    if (navigator.msSaveBlob) navigator.msSaveBlob(i, r); else {
    ...
    var r = OrgChart.templates[t], i = null;
    ...
    this.innerBar.innerHTML = "&nbsp", Object.assign(this.bar.style, {
        ...
        if (this.ignore) this.ignore = !1; else {
            var t = a.requestParams(), e = (parseFloat(a.innerBar.clientWidth) - parseFloat(a.bar.clientWidth)) / 100,
    ...
    this.bar && this.bar.parentNode.removeChild(this.bar), this.bar = document.createElement("div"), this.innerBar = document.createElement("div"), this.innerBar.innerHTML = "&nbsp", Object.assign(this.bar.style, {
        ...
        if (this.ignore) this.ignore = !1; else {
            var t = a.requestParams(), e = (parseFloat(a.innerBar.clientHeight) - parseFloat(a.bar.clientHeight)) / 100,
    ...
    for (var e, r, i, a, n, o = "", l = 0; l < this.config.clinks.length; l++) {
        var s = this.config.clinks[l], h = t.res.visibleNodes[s.from], d = t.res.visibleNodes[s.to];
        if (h && d) {
            var c = {}, g = {}, p = h.x + h.w / 2, f = d.x + d.w / 2, u = h.y + h.h / 2, C = d.y + d.h / 2, m = 1;
            switch (this.config.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
