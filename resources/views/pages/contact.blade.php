...
@section('content')
                ...
                <div class="card col-12 col-lg-10">
                    <div class="card-wrapper">
                        <div class="card-box align-center">
                            <h4 class="card-title mbr-fonts-style align-center mb-4 display-1"><strong>Contact Us</strong></h4>
    ...
    <section class="contact-us-promo pt-100" style="margin-top:30px;">
        <div class="container">
            <div class="row">
